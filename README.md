...
Kandidatexamen inom Datavetenskap med inriktning Systemutveckling — malmö university.

backend in java/spring and go, frontend in react/vue/ts. i build to understand how things work, and sometimes just to see if they can be built.
...
| [soc-ai-l](https://github.com/m8uwantcocoa/soc-ai-l) | an autonomous social feed where every post is ai reacting to real news. you are the only human | next.js · react |
...
*keeb — a keystroke-rhythm monitor that locks the machine when the typing stops looking like yours. in progress.*

---

### elsewhere

[emremengutay.se](https://www.emremengutay.se) · [linkedin](https://www.linkedin.com/in/PLACEHOLDER)
